...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.05,
        help="Duration in hours (default: 3 minutes)",
    )
    parser.add_argument(
        "--config", default="trade-config.json", help="Config file path"
    )
    ...
    trader = LiveTrader(model_path=args.model_path, dry_run=True)
