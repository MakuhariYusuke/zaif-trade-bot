...
describe('services/execution-service submitWithRetry', () => {
  ...
  const { submitWithRetry } = await import('../../../ztb/adapters/execution-service');
  ...
  const { init, submitWithRetry } = await import('../../../ztb/adapters/execution-service');
  const ms = await import('../../../ztb/adapters/market-service');
