...
class CoinGeckoAPI:
    ...
    def _get_cache_key(self, coin_id: str, vs_currency: str, days: int, interval: str) -> str:
...
def fetch_btc_jpy(days: int = 365, interval: str = "daily", years: Optional[int] = None) -> pd.DataFrame:
    """
