...
| M2 | Bayesian Regime Detection | ★★★☆☆ (50%) | 1-2d | **高** — 遷移予測 | ⚠ 一部可 | ⏳ 未着手 |
| M3 | σ-Clustering (Vol Regime) | ★★★★☆ (70%) | 4-8h | **中** — offset 適応精度↑ | ✅ 候補 | ⏳ 未着手 (T5✅前提) |
| M4 | GLFT Fill Probability Model | ★★★★☆ (80%) | 4-8h | **高** — fill 最適化 | ⚠ 設計依存 | ⏳ 未着手 |
| M5 | Volume-Sync VPIN | ★★★☆☆ (60%) | 4-8h | **中** — toxicity 精度↑ | ✅ 候補 | ⏳ 未着手 |
