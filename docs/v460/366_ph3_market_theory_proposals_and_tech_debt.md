...
| # | 提案 | 既存基盤 | 追加工数 | 収益インパクト | Codex 委任 |
|---|---|---|---|---|---|
| M1 | Microprice L1→L5 拡張 | ★★★★★ (90%) | 2-4h | **高** — AS 低減直結 | ✅ 候補 |
| M2 | Bayesian Regime Detection | ★★★☆☆ (50%) | 1-2d | **高** — 遷移予測 | ⚠ 一部可 |
| M3 | σ-Clustering (Vol Regime) | ★★★★☆ (70%) | 4-8h | **中** — offset 適応精度↑ | ✅ 候補 |
| M4 | GLFT Fill Probability Model | ★★★★☆ (80%) | 4-8h | **高** — fill 最適化 | ⚠ 設計依存 |
| M5 | Volume-Sync VPIN | ★★★☆☆ (60%) | 4-8h | **中** — toxicity 精度↑ | ✅ 候補 |
| T1-T10 | 技術負債 | — | 各1-4h | 安定性向上 | ✅ 最適 |
