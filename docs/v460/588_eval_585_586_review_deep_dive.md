...
>
> **Post-587# Note (2026-03-24)**: §1.3 の三重切断は Codex 587# (cc379f833 + c11bccaed) で修復済み。
> `execution_additive_enabled` フィールドは FillRecord に追加され、`_build_fill_record` からも渡されている。
> また §2.1 eDRC 入力クリップは 589# で対応、§4.2 B1-B5 は全て完了。
