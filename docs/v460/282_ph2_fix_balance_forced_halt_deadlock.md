...
| 09:00-13:08 | 25 fills: buy 12回 (-12.01bps), sell 13回 (-11.31bps) |
| 13:08 | buy #24 (-5.77bps) → 累計 -33.9bps → per-side halt 発動 |
...
## 4. 13:08 以前のログ分析 — デッドロック前兆の解剖

### 4.1 取引サマリ (09:00-13:08 JST)
