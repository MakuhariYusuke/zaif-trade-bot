...
### TrainingReporter
Location: ztb/training/unified_trainer/components/reporter.py
...
class MyTrainer:
    ...
    def on_training_complete(self, stats: Dict[str, Any]):
        self.reporter.report_training_complete(stats)
```
...
class MyTrainer:
    ...
    def train(self):
        self.reporter.log_training_start(self.config)
        ...
        self.reporter.log_training_complete({'final_step': step})
```
