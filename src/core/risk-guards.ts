...
/**
 * Validate the order placement against risk management rules.
 * @param {GuardContext} orderGuard The context for the order being placed.
 * @returns {GuardResult} The result of the validation.
 */
...
// Backward-compat shim (to be removed): map GuardResult.isAllowed to ok
