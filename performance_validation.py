...
print(f'   Data integrity: {loaded is not None and loaded["result"]["test"] == "performance"} ✓')
print()
...
print(f'   Tasks completed: {parallel_result["completed_tasks"]}/{parallel_result["total_tasks"]} ✓')
print()
