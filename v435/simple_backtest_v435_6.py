#!/usr/bin/env python3
"""
Simple backtest for SAC v435.6 model (ensemble majority voting)
"""
...
def main():
    print("🚀 SAC v435.6 Backtest (Ensemble Majority Voting)")
    print("=" * 50)
    ...
    metadata_path = "models/schemas/sac_v435.6/metadata.json"
    try:
    ...
    for i in range(len(df)):
        ...
        obs = np.array(
            [
                df.iloc[i]["close"] / 1000000,  # Normalized price
    ...
    print_formatted_metrics(results, "SAC v435.6 Backtest Results")

    # Save results
    with open("results/sac_v435_6_backtest.json", "w") as f:
        json.dump(results, f, indent=2)

    print("✅ Results saved to results/sac_v435_6_backtest.json")
