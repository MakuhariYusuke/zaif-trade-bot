#!/usr/bin/env python3
"""
SAC v435.7b Training - Zero frequency penalty with symmetric thresholds
ゼロ頻度ペナルティ + 対称閾値による値の焦げ付き防止
"""
import json
import logging
import sys
...
def main():
    ...
    print("🚀 SAC v435.7b Training - Zero frequency penalty")
    print("=" * 55)

    # 設定ファイルのパス
    config_dir = Path("v435/v435.7")
    config_path = config_dir / "sac_v435_7b_config.json"
    env_config_path = config_dir / "sac_v435_environment_config.json"
    reward_config_path = config_dir / "sac_v435_7b_reward_config.json"
