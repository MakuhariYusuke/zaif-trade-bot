...
class TestBacktestSACv438Quick:
    ...
    def test_calculate_backtest_summary_empty_portfolio(self):
        ...
        assert 'max_drawdown' not in summary  # Should not be calculated for empty portfolio
    ...
    def test_backtest_sac_v438_quick_model_not_found(
        self, mock_logger, mock_makedirs, mock_read_csv,
        mock_feature_engineer, mock_env, mock_sac_load, mock_path
    ):
    ...
    def test_backtest_sac_v438_quick_success(
        self, mock_calc_summary, mock_logger, mock_makedirs, mock_read_csv,
        mock_feature_engineer, mock_env, mock_sac_load, mock_path
    ):
        ...
        mock_feature_engineer.return_value.generate_v427_features.return_value = mock_features_df

        # Mock environment
        mock_env_instance = Mock()
        mock_env.return_value = mock_env_instance
        mock_env_instance.reset.return_value = (Mock(), {})
        mock_env_instance.step.return_value = (Mock(), 10.0, True, False, {'portfolio_value': 200100, 'trade_executed': True})
    ...
    def test_run_quick_backtest(self):
        ...
        with patch('scripts.backtest.backtest_sac_v438_quick.backtest_sac_v438_quick') as mock_backtest:
