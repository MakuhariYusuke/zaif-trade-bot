...
class TestLagrangeConstraintUnit:
    ...
    def test_compute_penalty_no_sell(self):
        ...
        assert abs(info["constraint_violation"] - 0.10) < 0.01  # tolerance for floating point
    ...
    def test_warmup_period(self):
        ...
        lagrange = LagrangeConstraint(target_action="SELL", r_target=0.15, warmup_steps=100, tolerance=0.05)
        ...
        assert penalty < 0.0, f"Penalty should be negative when there's a violation, got {penalty}"
