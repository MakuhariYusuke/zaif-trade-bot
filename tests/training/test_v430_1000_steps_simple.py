#!/usr/bin/env python3
"""
SAC v430 Test Training - 1000 Steps Validation (Direct SB3)
"""
...
def run_test_training():
    ...
    try:
        ...
        reward_settings = RewardSettings(
            reward_scale=env_config["reward_settings"]["reward_scale"],
            trading_bonus=env_config["reward_settings"]["trading_bonus"],
            sell_penalty=env_config["reward_settings"]["sell_penalty"],
            buy_bonus=env_config["reward_settings"]["buy_bonus"],
            action_balance_weight=env_config["reward_settings"][
                "action_balance_weight"
            ],
            hold_penalty=env_config["reward_settings"]["hold_penalty"],
            risk_penalty=env_config["reward_settings"]["risk_penalty"],
        )
        ...
        env_config_obj = EnvironmentConfig(
            ...
            reward_position_penalty_scale=env_config["reward_settings"][
                "trading_bonus"
            ],
            use_continuous_actions=True,  # Enable continuous actions for SAC
            # Add other reward settings as needed
        )
        ...
        # Save model
        model_path = "models/sac_v430_test/final_model.zip"
