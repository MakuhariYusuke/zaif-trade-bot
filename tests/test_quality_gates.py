...
from ztb.evaluation.status import FeatureStatus
...
class TestQualityGates:
    ...
    def setup_method(self):
        ...
        self.sample_data = pd.DataFrame({
            ...
            'feature_nan': [np.nan if i % 10 != 0 else np.random.randn() for i in range(2000)],  # 90% NaN
            'feature_skewed': np.random.beta(0.1, 10, 2000),  # Even more skewed beta distribution
    ...
    def test_dual_correlation_short_term_pass(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_good'], self.sample_data['close'], 'test_feature_short')
    ...
    def test_dual_correlation_long_term_pass(self):
        ...
        # Use the pre-created highly correlated feature
        result = self.quality_gates.evaluate(self.sample_data['feature_good'], self.sample_data['close'], 'test_feature_long')
    ...
    def test_dual_correlation_both_fail(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_bad'], self.sample_data['close'], 'test_feature_bad')
    ...
    def test_nan_rate_pass(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_good'], self.sample_data['close'], 'test_feature')
    ...
    def test_nan_rate_fail(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_nan'], self.sample_data['close'], 'test_feature_nan')
    ...
    def test_skew_fail(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_skewed'], self.sample_data['close'], 'test_feature_skewed')
    ...
    def test_kurtosis_fail(self):
        ...
        result = self.quality_gates.evaluate(self.sample_data['feature_kurtotic'], self.sample_data['close'], 'test_feature_kurtotic')
