...
class TestBearishSignalFeatures:
    ...
    def test_error_handling(self, feature_engineer, sample_data):
        ...
        with patch.object(
            feature_engineer,
            "_add_bearish_divergence_features",
    ...
    def test_integration_with_generic_features(self, feature_engineer, sample_data):
        ...
        with patch(
            ...
            bearish_features = feature_engineer._generate_bearish_signal_features(
                sample_data
            )
            ...
            bearish_cols = [
                ...
                if col.startswith("Bearish_") or "Sell" in col or "Divergence" in col
            ]
