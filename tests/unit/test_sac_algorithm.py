...
class TestSACValidateConfig:
    ...
    def test_missing_required_param(self):
        ...
        with pytest.raises(ValueError, match="Missing required SAC parameter: learning_rate"):
        ...
        with pytest.raises(ValueError, match="Missing required SAC parameter: buffer_size"):
            SACAlgorithm.validate_config(config)
