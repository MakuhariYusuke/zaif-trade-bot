...
class TestConfidencePenaltyReward(unittest.TestCase):
    ...
    def create_context(
        ...
        # Use a simple object for settings instead of MagicMock to avoid attribute creation issues
        class SimpleSettings:
            def __init__(self, data):
                self.__dict__.update(data)
                self.custom_reward_params = {} # Ensure this exists
            def get(self, k):
                return self.__dict__.get(k)
        
        settings = SimpleSettings(self.mock_settings)
    ...
    def test_no_penalty_on_profit(self):
    ...
    def test_hinge_penalty_calculation(self):
    ...
    def test_fallback_loss_magnitude(self):
