...
def test_env_config_from_config_file_sets_continuous_action_fix():
    """Load the sample test config and ensure use_continuous_actions is preserved/recognized.
    This is a duplicate of the existing test but placed in a new file to avoid parsing issues
    with the malformed test file that exists in the repo."""
