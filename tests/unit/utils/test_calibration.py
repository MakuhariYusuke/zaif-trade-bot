...
def test_reliability_curve_perfect_calibration():
    ...
    result = compute_reliability_curve(predicted_probs, actual_actions, action_idx=0, n_bins=5)
...
def test_reliability_curve_poor_calibration():
    ...
    result = compute_reliability_curve(predicted_probs, actual_actions, action_idx=0, n_bins=10)
