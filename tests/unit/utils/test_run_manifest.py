...
def test_compare_manifests_ignore_git():
    ...
    are_compatible, differences = compare_manifests(manifest1, manifest2, ignore_git=True)
    assert are_compatible is True
    
    # With ignore_git=False
    are_compatible, differences = compare_manifests(manifest1, manifest2, ignore_git=False)
    assert are_compatible is False
