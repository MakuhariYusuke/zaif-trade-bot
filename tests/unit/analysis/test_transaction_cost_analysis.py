...
try:
    ...
    pytest.skip(
        "ztb.analysis.transaction_cost_analysis module not available",
...
class TestTransactionCostAnalysis:
    ...
    def test_simulate_transaction_costs_normal(
        self, mock_to_csv, mock_plt, mock_evaluator_class
    ):
    ...
    @patch("ztb.analysis.transaction_cost_analysis.plt")
    @patch("ztb.analysis.transaction_cost_analysis.pd.DataFrame.to_csv")
    def test_simulate_transaction_costs_evaluator_error(
        self, mock_to_csv, mock_plt, mock_evaluator_class
    ):
    ...
    def test_simulate_transaction_costs_safe_operation_failure(
        self, mock_safe_operation
    ):
