...
def test_merge_reward_components_preserves_stage_and_converts_scalars() -> None:
    payload: dict[str, object] = build_reward_components(
        "forced_balance",
        base_reward=0.0,
    )
    ...
    merge_reward_components(
        ...
        {
            "base_reward": 0.25,
            "corrective_bonus": 0.1,
            "enabled": True,
            "note": "kept",
            "stage": "should_not_override",
        },
    )
