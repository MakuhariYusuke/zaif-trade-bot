...
_EVALUATE_SKIP_GATE_SIG = inspect.signature(FillTestRunner._evaluate_skip_gate)
_CHECK_BALANCE_FOR_SIDE_SIG = inspect.signature(FillTestRunner._check_balance_for_side)
...
class TestCheckBalanceAcceptsRegimeMult:
    ...
    def test_signature_has_regime_mult(self) -> None:
        params = _CHECK_BALANCE_FOR_SIDE_SIG.parameters
