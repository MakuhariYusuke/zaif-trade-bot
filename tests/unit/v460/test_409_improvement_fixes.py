...
def _make_threshold_config() -> SimpleNamespace:
    return SimpleNamespace(
        ...
        z_score_method="std",
        regime_adaptive_threshold=False,
...
class TestH3ZeroPriceGuard:
    ...
    def test_zero_price_in_history_no_crash(self):
        ...
        mock_detector = SimpleNamespace(price_history=[0.0, 100.0, 200.0, 0.0, 300.0] * 4)
    ...
    def test_all_zero_prices_returns_finite(self):
        ...
        mock_detector = SimpleNamespace(price_history=[0.0] * 20)
