...
_PNL_MEASURER_MEASURE_SIG = inspect.signature(PnlMeasurer.measure)
...
class TestOrderMonitorChaseIntegration:
    ...
    def test_chase_params_override_stale_default(self):
        ...
        assert "chase_drift_bps_override" in _ORDER_MONITOR_MONITOR_SIG.parameters
        assert "chase_max_reprice_override" in _ORDER_MONITOR_MONITOR_SIG.parameters
...
class TestPnlMeasurerOverride:
    ...
    def test_measure_accepts_wait_sec_override(self):
        assert "wait_sec_override" in _PNL_MEASURER_MEASURE_SIG.parameters
