...
class TestSkipSellUnknownRegime:
    ...
    def test_evaluator_skips_sell_unknown(self, config: "FillTestConfig") -> None:
        ...
        # SkipGateEvaluator init はモデルロードするが、ここでは mock
        with patch(
            ...
            evaluator._skip_gate = MagicMock()  # 非 None → 有効
    ...
    def test_evaluator_passes_sell_trending(self, config: "FillTestConfig") -> None:
        ...
        mock_decision.predicted_pnl_bps = 0.5
        mock_decision.reason = "pass"
        mock_decision.model_used = "primary"
        mock_decision.as_probability = 0.30
        mock_decision.threshold_used = 0.50
        mock_decision.features_used = 16
