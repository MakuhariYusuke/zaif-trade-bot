...
class TestSACTrainerRegimeAdaptation:
    ...
    def test_regime_statistics_initialization(
        self, trainer_config, mock_env, mock_classifier
    ):
    ...
    def test_regime_statistics_tracking(
        self, trainer_config, mock_env, mock_classifier
    ):
    ...
    def test_training_with_regime_adaptation(
        self, trainer_config, mock_env, mock_classifier
    ):
    ...
    def test_regime_transition_tracking(
        self, trainer_config, mock_env, mock_classifier
    ):
