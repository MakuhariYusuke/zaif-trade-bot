...
class CompressionBenchmark:
    ...
    def benchmark_compression(
        self, data: Dict[str, Any], compression_type: str
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "compression_speed_mbps": (original_size / (1024 * 1024))
            / compression_time,
            "decompression_speed_mbps": (original_size / (1024 * 1024))
            / decompression_time,
        }
        ...
        for size_mb in data_sizes_mb:
            ...
            for comp_type in compression_types:
                try:
                    ...
                    print(f"  {comp_type.upper():4}: .1f.1f.3f.1f.1f")
        ...
        for comp_type, results in by_type.items():
            ...
            summary[comp_type] = {
                ...
                "avg_total_time": np.mean(
                    [t + d for t, d in zip(comp_times, decomp_times)]
                ),
