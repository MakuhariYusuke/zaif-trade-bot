...
def verify_curriculum_stage_flow():
    ...
    training_env_direct = unified_config_direct.get("training", {}).get("environment", {})
    env_curriculum_stage_direct = training_env_direct.get("curriculum_stage")
    
    print(f"  ✓ Direct conversion training.environment.curriculum_stage: {env_curriculum_stage_direct}")
    ...
    print(f"  ✓ With ConfigLoader training.environment.curriculum_stage: {env_curriculum_stage}")
    ...
    training_curriculum_learning = unified_config.get("training", {}).get("curriculum_learning", {})
    curriculum_stage_preserved = training_curriculum_learning.get("curriculum_stage")
    
    print(f"  ✓ Unified config training.curriculum_learning.curriculum_stage: {curriculum_stage_preserved}")
    ...
    print("  1. Raw config: training.curriculum_learning.curriculum_stage = 'balanced_penalty' ✅")
    print("  2. Unified config: training.environment.curriculum_stage = 'balanced_penalty' ✅")
