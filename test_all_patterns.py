...
def test_all_patterns():
    ...
    for pattern_name, pattern_class in patterns:
        try:
            ...
            signal = recognizer.recognize(data, multi_timeframe_data=multi_timeframe_data)
            ...
            if signal:
                print(f"   Type: {signal.signal_type}, Strength: {signal.strength:.3f}, Direction: {signal.direction}")
