        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                if self.enable_pan and self.pan_normalizer is not None:
                    ...
                    # Apply PAN
                    advantages_np = self.pan_normalizer.normalize(advantages_np, actions_np)  # type: ignore
...
def explained_variance(y_pred: NDArray[np.float32], y_true: NDArray[np.float32]) -> float:
    """
