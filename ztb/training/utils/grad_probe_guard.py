...
class GradProbeConfig:
    ...
    critical_actions: List[str] = field(default_factory=lambda: ["SELL"])  # Actions that trigger halt
...
class GradProbeGuard(BaseCallback):
            ...
            if hasattr(policy, 'action_net'):
                ...
                for action_name in self.config.monitor_actions:
                    ...
                    if grad_norm is not None:
                        ...
                        stats.is_zero[action_name] = grad_norm < self.config.zero_threshold
                        ...
                        stats.consecutive_zero_count[action_name] = self.consecutive_zeros[action_name]
    ...
    def _get_action_grad_norm(self, action_net: Any, action_name: str) -> Optional[float]:
        """
