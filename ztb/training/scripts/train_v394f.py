...
def main():
    ...
    print(f"  - ent_coef: 0.01 → 0.2 (20x) 🔥🔥🔥")
    print(f"  - Same aggressive reward settings as v394d")
    print(f"  - Goal: Maintain entropy >1.0 throughout training")
    print(f"  - Target: HOLD ratio <70% at 100k timesteps")
    print()
