...
class TestSelfSupervisedTrainer:
    ...
    def test_train_success(self, mock_load_data, mock_ssp_trainer, basic_config, sample_data):
    ...
    @patch('ztb.multimodal.pretraining.SelfSupervisedTrainer')
    @patch.object(SelfSupervisedTrainer, '_load_data')
    def test_train_exception_handling(self, mock_load_data, mock_ssp_trainer, basic_config):
    ...
    @patch.object(SelfSupervisedTrainer, '_load_data')
    @patch('ztb.multimodal.pretraining.SelfSupervisedTrainer')
    def test_get_training_stats_with_trainer(self, mock_ssp_trainer, mock_load_data, basic_config, sample_data):
