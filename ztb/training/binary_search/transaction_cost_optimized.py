...
def main() -> None:
    parser = BinarySearchArgumentParser.create_parser('Optimize transaction_cost parameter for environment')
    BinarySearchArgumentParser.add_parameter_argument(parser, 'transaction_cost', float, 0.001)
