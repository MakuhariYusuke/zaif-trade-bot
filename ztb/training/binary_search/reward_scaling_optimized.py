...
def main() -> None:
    parser = BinarySearchArgumentParser.create_parser('Optimize reward_scaling parameter for environment')
    BinarySearchArgumentParser.add_parameter_argument(parser, 'reward_scaling', float, 6.0)
