...
def main() -> None:
    parser = BinarySearchArgumentParser.create_parser('Optimize risk_free_rate parameter for environment')
    BinarySearchArgumentParser.add_parameter_argument(parser, 'risk_free_rate', float, 0.02)
