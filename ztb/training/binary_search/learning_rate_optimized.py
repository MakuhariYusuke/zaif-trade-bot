...
def main() -> None:
    parser = BinarySearchArgumentParser.create_parser('Optimize learning_rate parameter for PPO')
    BinarySearchArgumentParser.add_parameter_argument(parser, 'learning_rate', float, 5e-4)
