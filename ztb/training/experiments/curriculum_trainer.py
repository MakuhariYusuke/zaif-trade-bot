...
class CurriculumTrainer:
    ...
    def _create_phase_config(self, phase: CurriculumPhase, prev_model_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        phase_config["environment"]["reward_settings"]["consecutive_action_penalty"] = phase.consecutive_action_penalty
        phase_config["environment"]["reward_settings"]["diversity_bonus_weight"] = phase.diversity_bonus_weight
        phase_config["environment"]["reward_settings"]["min_diversity_threshold"] = phase.min_diversity_threshold
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="models/curriculum", help="Output directory")
