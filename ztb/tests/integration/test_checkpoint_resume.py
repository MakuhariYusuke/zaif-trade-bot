...
from ztb.training.checkpoint_manager import TrainingCheckpointManager, TrainingCheckpointConfig
...
def test_streaming_checkpoint_kill_and_resume(tmp_path: Path, total_steps: int, partial_steps: int) -> None:
