...
from ztb.utils.memory_monitor import check_memory_usage, get_memory_usage, log_memory_usage
...
class TestMemoryMonitor:
    ...
    def test_check_memory_usage_disabled_by_default(self):
        ...
        with patch('psutil.Process') as mock_process:
            with patch('builtins.print') as mock_print:
                mock_proc_instance = MagicMock()
                mock_proc_instance.memory_info.return_value.rss = 2000 * 1024 * 1024  # 2000MB
                mock_process.return_value = mock_proc_instance
    ...
    def test_check_memory_usage_enabled_below_threshold(self):
        ...
        with patch.dict(os.environ, {'ZTB_DEV_MEMORY_WARN': '1'}):
            with patch('psutil.Process') as mock_process:
                with patch('builtins.print') as mock_print:
                    mock_proc_instance = MagicMock()
                    mock_proc_instance.memory_info.return_value.rss = 500 * 1024 * 1024  # 500MB
                    mock_process.return_value = mock_proc_instance
    ...
    def test_check_memory_usage_enabled_above_threshold(self):
        ...
        with patch.dict(os.environ, {'ZTB_DEV_MEMORY_WARN': '1'}):
            with patch('psutil.Process') as mock_process:
                with patch('builtins.print') as mock_print:
                    mock_proc_instance = MagicMock()
                    mock_proc_instance.memory_info.return_value.rss = 1500 * 1024 * 1024  # 1500MB
                    mock_process.return_value = mock_proc_instance
    ...
    def test_check_memory_usage_custom_threshold(self):
        ...
        with patch.dict(os.environ, {'ZTB_DEV_MEMORY_WARN': '1'}):
            with patch('psutil.Process') as mock_process:
                with patch('builtins.print') as mock_print:
                    mock_proc_instance = MagicMock()
                    mock_proc_instance.memory_info.return_value.rss = 2500 * 1024 * 1024  # 2500MB
                    mock_process.return_value = mock_proc_instance
    ...
    def test_check_memory_usage_at_exact_threshold(self):
        ...
        with patch.dict(os.environ, {'ZTB_DEV_MEMORY_WARN': '1'}):
            with patch('psutil.Process') as mock_process:
                with patch('builtins.print') as mock_print:
                    mock_proc_instance = MagicMock()
                    mock_proc_instance.memory_info.return_value.rss = 1000 * 1024 * 1024  # 1000MB
                    mock_process.return_value = mock_proc_instance
    ...
    def test_log_memory_usage_without_label(self):
        ...
        with patch('psutil.Process') as mock_process:
            with patch('builtins.print') as mock_print:
                mock_proc_instance = MagicMock()
                mock_proc_instance.memory_info.return_value.rss = 75.5 * 1024 * 1024  # 75.5MB
                mock_process.return_value = mock_proc_instance
    ...
    def test_log_memory_usage_with_label(self):
        ...
        with patch('psutil.Process') as mock_process:
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_called_once_with("Memory usage [after training]: 200.0MB")
