...
class TestWeeklyReportGeneration:
    ...
    def test_weekly_report_contains_unverified_section(self, temp_dir, mock_evaluator):
        ...
        with (
            patch.object(generate_weekly_report, "load_ablation_results") as mock_load,
            patch.object(
                generate_weekly_report, "load_evaluation_config"
            ) as mock_config,
            ...
            mock_load.return_value = {
                "ablation_results": {
                    ...
                    "FeatureB": {
                        "delta_sharpe": {"mean": -0.02, "ci95": [-0.05, 0.01]}
                    },
                }
            }
...
"""
    ...
    def test_report_content_validation(self):
        ...
        assert (
            sections["verified_count"]
            + sections["unverified_count"]
            + sections["failed_count"]
            == 10
        )
