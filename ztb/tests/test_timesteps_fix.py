...
def test_timesteps_override():
    ...
    test_config = {
        ...
        "algorithm": "ppo",
        "training": {
            "total_timesteps": 999999  # Should be overridden
        },
    ...
    print(f"Command-line override: 1000")
    print()
    ...
    # Summary
    all_pass = (
        result1 == 999999 and ppo_result1 == 999999 and
        result2 == 1000 and ppo_result2 == 1000 and
        result3 == 1000 and ppo_result3 == 1000
    )
