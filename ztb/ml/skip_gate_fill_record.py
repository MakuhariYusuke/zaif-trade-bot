...
def build_skip_fill_record_from_context(
    *,
    ...
    return build_skip_fill_record(
        ...
        as_trailing_gate_action=extra_fields.as_trailing_gate_action,
        as_trailing_gate_rate=extra_fields.as_trailing_gate_rate,
        as_trailing_gate_offset_mult=extra_fields.as_trailing_gate_offset_mult,
