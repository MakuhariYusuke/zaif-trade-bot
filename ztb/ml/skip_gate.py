...
118# E11 / 372# 解消: scripts/v460/ml/ → ztb/ml/ に移動完了。
旧パス scripts/v460/ml/skip_gate.py は互換シムとして残存。
...
from ztb.ml.skip_gate_features import (
