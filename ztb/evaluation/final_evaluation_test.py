...
def simulate_backtest(model_config, test_scenarios=1000):
    ...
    # Market scenarios
    scenarios = [
        {"name": "Bull Market", "trend": 0.3, "volatility": 0.5, "description": "Strong upward trend"},
        {"name": "Bear Market", "trend": -0.3, "volatility": 0.5, "description": "Strong downward trend"},
        {"name": "Sideways Market", "trend": 0.0, "volatility": 0.3, "description": "Range-bound market"},
        {"name": "High Volatility", "trend": 0.0, "volatility": 1.0, "description": "High volatility, no clear trend"},
        {"name": "Low Volatility", "trend": 0.1, "volatility": 0.2, "description": "Low volatility, slight upward trend"}
    ]
