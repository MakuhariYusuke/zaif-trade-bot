#!/usr/bin/env python3
"""
SAC v432.6 Evaluation Script with Ensemble Approach
Specialized models for different market conditions with early exits
"""
...
def load_config():
    """Load v432.6 configuration"""
    config_path = get_project_root() / "ztb" / "configs" / "v432" / "sac_v432_6_ensemble_approach.json"
...
def run_backtest_simulation_v432_3(config, num_steps=10000, initial_capital=10000.0):
    ...
    print("=== SAC v432.6 Ensemble Approach Backtest ===")
    ...
    for step in range(1, num_steps):
        ...
        action, reward, market_condition, confidence = simulate_sac_v432_6_action(
    ...
    print("\n=== SAC v432.6 Ensemble Approach Results ===")
...
def main():
    ...
    # Save results
    output_file = get_project_root() / "ztb" / "evaluation" / "v432" / "sac_v432_6_ensemble_approach_results.json"
    ...
    print("\n=== SAC v432.6 Ensemble Approach Evaluation Complete ===")
