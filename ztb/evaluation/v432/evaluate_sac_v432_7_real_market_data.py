...
def main():
    ...
    results = run_backtest_simulation_v432_3(config, num_steps=5000, initial_capital=10000.0)

    # Save results
    output_file = get_project_root() / "ztb" / "evaluation" / "v432" / "sac_v432_7_real_market_data_results.json"
