...
def load_config():
    ...
    config_path = get_project_root() / "ztb" / "configs" / "v432" / "sac_v432_3_entry_exit_enhancement.json"
...
def simulate_sac_v432_3_action(
    ...
    """Simulate SAC v432.3 action with Entry/Exit Enhancement"""
...
def run_backtest_simulation_v432_3(config, num_steps=10000, initial_capital=10000.0):
    ...
    print("=== SAC v432.3 Entry/Exit Strategy Enhancement Backtest ===")
    ...
    for step in range(1, num_steps):
        ...
        action, reward, market_condition, confidence = simulate_sac_v432_3_action(
...
def main():
    ...
    # Save results
    output_file = get_project_root() / "ztb" / "evaluation" / "v432" / "sac_v432_3_entry_exit_enhancement_results.json"
