...
class ComprehensiveEvaluation:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'results': {k.value: {'value': v.value, 'confidence_interval': v.confidence_interval,
                                 'benchmark_comparison': v.benchmark_comparison, 'metadata': v.metadata}
...
class UnifiedEvaluator:
    ...
    def evaluate_model(self,
                      ...
                      benchmark_data: Optional[Union[str, Path]] = None) -> ComprehensiveEvaluation:
        """
        モデルを評価
        ...
        self.logger.info(f"Evaluation completed for {model_name}. Summary score: {evaluation.get_summary_score():.3f}")

        return evaluation

    def _calculate_basic_metrics(self, data_path: Union[str, Path]) -> Dict[EvaluationMetric, EvaluationResult]:
        """基本的な評価指標を計算"""
        ...
        results[EvaluationMetric.TOTAL_RETURN] = EvaluationResult(
            metric=EvaluationMetric.TOTAL_RETURN,
            value=0.25
        )
    ...
    def _calculate_performance_metrics(self, data_path: Union[str, Path]) -> Dict[str, Any]:
        """パフォーマンス指標を計算"""
        return {
            'win_rate': 0.55,
            'profit_factor': 1.3,
    ...
    def _calculate_summary_stats(self, evaluation: ComprehensiveEvaluation) -> Dict[str, Any]:
        """サマリー統計を計算"""
        return {
    ...
    def save_evaluation(self, evaluation: ComprehensiveEvaluation,
    ...
    def compare_evaluations(self, evaluations: List[ComprehensiveEvaluation]) -> Dict[str, Any]:
        """複数の評価結果を比較"""
        if not evaluations:
            return {}
        ...
        for eval in evaluations:
            ...
            if comparison['worst_model'] is None or score < comparison['worst_model'][1]:
        ...
        for metric in EvaluationMetric:
            metric_values = [(eval.model_name, eval.get_metric_value(metric))
                           for eval in evaluations]
