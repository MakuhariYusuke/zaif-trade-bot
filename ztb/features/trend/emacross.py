...
class EMACross(ParameterizedFeature):
    ...
    def _compute_with_params(self, df: pd.DataFrame, **params) -> pd.DataFrame:
        ...
        fast_period = params.get('fast_period', self.default_params['fast_period'])
        slow_period = params.get('slow_period', self.default_params['slow_period'])
