...
def calculate_donchian_extended(data: pd.DataFrame,
    ...
    features['donchian_upper_distance'] = (upper_channel - data['close']) / data['close']
    features['donchian_lower_distance'] = (data['close'] - lower_channel) / data['close']
    features['donchian_middle_distance'] = (data['close'] - middle_channel) / data['close']
    ...
    features['donchian_breakout_strength'] = breakout_strength_upper + breakout_strength_lower
...
def calculate_donchian_signals(extended_features: pd.DataFrame,
...
if __name__ == "__main__":
    ...
    key_features = ['donchian_width', 'donchian_price_position', 'donchian_breakout_strength']
