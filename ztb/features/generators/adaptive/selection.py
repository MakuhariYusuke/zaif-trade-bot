        ...
        if feature_groups is None:
            self.feature_groups = {
                "trending": [
                    ...
                    "sma_20", "sma_50", "trend_strength", "momentum",
                ],
                "ranging": [
                    "rsi_6", "rsi_14", "rsi_21", "stoch_k", "stoch_d",
                    "cci_14", "willr_14", "roc_10", "mfi_14",
                    "bb_upper", "bb_lower", "bb_middle", "oscillator_strength",
                ],
                "high_volatility": [
                    "atr_14", "natr_14", "trange", "bb_width",
                    "kc_width", "volatility_ratio", "price_change_1d",
                ],
                "low_volatility": [
                    "price_change_1d", "volume_ratio", "micro_trend", "precision_signals",
                ],
            }
        else:
