...
class SACv437FeatureEngineer:
    ...
    def _get_essential_price_data(self, df: pd.DataFrame) -> pd.DataFrame:
        """Get essential price data that must always be included for trading environment."""
        essential = pd.DataFrame(index=df.index)
