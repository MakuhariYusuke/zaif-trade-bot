...
class TestSystemOptimizer(unittest.TestCase):
    ...
    def test_get_system_stats(self):
        ...
        expected_keys = [
            'step_counter', 'memory_tracking_enabled', 'performance_profiling_enabled',
            'io_caching_enabled', 'cache_size', 'cache_hits',
...
class TestSystemOptimizerIntegration(unittest.TestCase):
    ...
    def test_memory_threshold_warnings(self):
        ...
        with patch.object(psutil.Process, 'memory_info', return_value=MagicMock(rss=200 * 1024 * 1024)):  # 200MB
