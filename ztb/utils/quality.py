...
class QualityGates:
    ...
    def evaluate(self, feature_data: pd.Series, price_data: pd.Series, mode: str = "normal", dataset: str = "synthetic") -> Dict[str, Any]:
        ...
        if len(valid_data) > 10:
            ...
            if len(short_data) > 10:
                ...
                results['corr_short'] = corr_long  # Fallback to long if insufficient data

            # Correlation pass: either short or long meets threshold
            results['correlation_pass'] = (results['corr_short'] >= gates['correlation_threshold'] or
