...
class AsyncNotifier:
    ...
    def __init__(
        ...
        # メトリクス追跡用
        self.metrics_callback: Callable[[], object] | None = None
...
class LoggerManager(LoggerProtocol):
    ...
    def _send_discord(
        self, message: str, embed_data: dict[str, object] | None = None
    ) -> bool:
    ...
    def log_error(self, error_message: str, details: str | None = None) -> None:
