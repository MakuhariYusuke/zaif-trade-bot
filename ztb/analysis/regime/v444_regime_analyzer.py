...
class V444RegimeAnalyzer:
    ...
    def validate_adaptive_strategy(
        self,
        model_predictions: ObjectMap,
        actual_performance: ObjectMap,
        regime_context: ObjectMap,
    ) -> ObjectMap:
        """
        アダプティブ戦略の有効性検証
    ...
    def _calculate_transition_matrix(
        ...
        matrix = {
            from_regime: dict.fromkeys(regimes, 0)
    ...
    def _calculate_transition_probabilities(
        ...
        for from_regime, transitions in transition_matrix.items():
            ...
            if total_transitions > 0:
                ...
                probabilities[from_regime] = dict.fromkeys(transitions.keys(), 0.0)
