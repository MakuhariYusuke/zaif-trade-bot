...
def main():
    ...
    print(f"  Critic Loss平均: {current_state['training_status']['critic_loss_avg']:.3f}")
    print(f"  改善率: {current_state['achievements']['critic_loss_improvement']}")
    print(f"  統計的有意性: {current_state['achievements']['statistical_significance']}")
    print()
    ...
    for category in short_term:
        ...
        for item in category['items']:
            ...
            print(f"    期待効果: {item['expected_benefit'] if isinstance(item['expected_benefit'], str) else '多面的な効果'}")
