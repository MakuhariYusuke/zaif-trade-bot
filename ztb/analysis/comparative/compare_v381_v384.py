...
# Load configurations
v381_config = json.loads(
    Path("configs/training/ppo_reward_v381_revised_profit_focused.json").read_text()
)
v384_config = json.loads(
    Path("configs/training/ppo_reward_v384_curated_60.json").read_text()
)
...
print(
    f"Total timesteps: {v381_config.get('total_timesteps', v381_config.get('ppo', {}).get('total_timesteps', 'N/A'))}"
)
...
print(
    f"Total timesteps: {v384_config.get('total_timesteps', v384_config.get('ppo', {}).get('total_timesteps', 'N/A'))}"
)
