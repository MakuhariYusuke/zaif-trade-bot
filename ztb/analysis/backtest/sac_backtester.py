...
from ztb.analysis.common.types import BacktestResult
...
from ztb.utils.safety import ensure_dict, safe_open_json
...
class SACBacktester:
    ...
    def _calculate_performance_metrics(
        ...
        return {
            ...
            "avg_trade_pnl": float(total_return / total_trades)
            if total_trades > 0
            else 0.0,
        }
    ...
    def print_report(self, result: BacktestResult) -> None:
        ...
        logger.info(
            "  Total Trades: %s", result.performance_metrics.get("total_trades")
        )
