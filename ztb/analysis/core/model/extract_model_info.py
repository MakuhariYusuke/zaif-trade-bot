    ...
    try:
        with zipfile.ZipFile(model_path, "r") as zip_ref:
            ...
            if data_file:
                ...
                try:
                    with zip_ref.open(data_file) as f:
                        ...
                        print(
                            f"  First 200 bytes (ascii): {data[:200].decode('ascii', errors='replace')}"
                        )
            ...
            if pkl_file:
                ...
                print("  Note: This contains model weights (not easily readable)")
            ...
            print(
                "  - または、逆算: モデルを実行してobservation spaceから特徴量数を推定"
            )
