...
class UnifiedAnalyzer:
    ...
    def analyze_performance(self, model: Any, **kwargs) -> Dict[str, Any]:
        """
        パフォーマンス分析
    ...
    def analyze_risk(self, model: Any, **kwargs) -> Dict[str, Any]:
        """
        リスク分析
    ...
    def analyze_behavior(self, model: Any, **kwargs) -> Dict[str, Any]:
        """
        行動分析
    ...
    def analyze_comparison(
        self, model: Any, baseline_models: Optional[List[str]] = None, **kwargs
    ) -> Dict[str, Any]:
        """
        比較分析
    ...
    def run_comprehensive_analysis(
        self, model: Any, config: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        包括的な分析を実行
