...
RUNS = {
    ...
    "v379_dynamic": Path("checkpoints/ppo_reward_v379_dynamic/ppo_reward_v379_dynamic_1"),
    "v380_aggressive": Path("checkpoints/ppo_reward_v380_aggressive/ppo_reward_v380_aggressive_1"),
}
...
def load_metrics(events_dir: Path) -> Dict[str, MetricStats]:
    ...
    scalar_tags = list(raw_scalar_tags) if isinstance(raw_scalar_tags, (list, tuple)) else []
