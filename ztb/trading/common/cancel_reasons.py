"""Canonical cancel reason constants shared across trading layers.

Originally introduced under `scripts/v460/lib/cancel_reasons.py`.
As of 505#, this `ztb` module is the canonical source of truth so
`ztb` code no longer depends on `scripts.v460.lib`.
