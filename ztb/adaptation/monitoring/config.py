...
from .types import MetricType, AlertLevel, AlertCondition, DashboardConfig, ReportConfig, SafetyLevel, AnomalyType, FallbackType
...
class MonitoringConfig:
    ...
    # メトリクス設定
    enabled_metric_types: List[MetricType] = field(default_factory=lambda: [
    ...
    dashboard_config: DashboardConfig = field(default_factory=lambda: DashboardConfig(
        ...
        metrics_to_display=["win_rate", "total_pnl", "sharpe_ratio", "max_drawdown"],
        chart_types={
            "win_rate": "line",
            "total_pnl": "area",
            "sharpe_ratio": "bar",
    ...
    # システム閾値
    system_thresholds: Dict[str, Dict[str, float]] = field(default_factory=lambda: {
...
class ScalabilityConfig:
    ...
    load_distribution_algorithm: str = "round_robin"  # round_robin, least_connections, weighted
...
class EvaluationConfig:
    ...
    # レポート設定
    report_settings: Dict[str, Any] = field(default_factory=lambda: {
    ...
    # 自動対応設定
    auto_response: Dict[str, Any] = field(default_factory=lambda: {
...
class AlertConfig:
    ...
    # アラートレベルごとの設定
    alert_levels: Dict[AlertThreshold, Dict[str, Any]] = field(default_factory=lambda: {
        AlertThreshold.LOW: {
            'enabled': True,
    ...
    # アラートタイプごとの設定
    alert_types: Dict[str, Dict[str, Any]] = field(default_factory=lambda: {
        'performance': {
            'enabled': True,
