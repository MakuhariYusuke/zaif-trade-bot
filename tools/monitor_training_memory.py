...
def monitor_training_process(pid: int, duration_seconds: int = 60) -> None:
    ...
    try:
        ...
        while time.time() - start_time < duration_seconds:
            try:
                ...
                print(
                    f"{timestamp:<12} {rss_mb:<12.2f} {vms_mb:<12.2f} {cpu_percent:<8.1f}"
                )
        ...
        if max_memory < 500:
            print("✅ Memory usage stayed under 500MB limit!")
        else:
            print("⚠️  Memory usage exceeded 500MB limit")
