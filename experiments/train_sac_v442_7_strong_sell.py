#!/usr/bin/env python3
"""
SAC v442.7 Strong SELL Trading Training

売買アクションのバランスを重視した学習:
- シングルタイムフレームのみ
- 基本的なテクニカル指標のみを使用
- Long/Short報酬をさらに調整して売買バランスを改善 (long: 1.0, short: 2.0)
- 安定性重視の報酬関数
...
def main() -> int:
    ...
    try:
        # 設定ファイル読み込み
        config_path = project_root / "config" / "sac_v442_7_strong_sell_config.json"
