#!/usr/bin/env python3
"""
SAC v442.2 Balanced Trading Training

売買アクションのバランスを重視した学習:
- シングルタイムフレームのみ
- 基本的なテクニカル指標のみを使用
- Long/Short報酬を調整して売買バランスを改善
- 安定性重視の報酬関数
...
def main() -> int:
    parser = argparse.ArgumentParser(description="SAC v442.2 Balanced Trading Training")
    parser.add_argument(
        "--timesteps",
        type=int,
        default=None,
    ...
    parser.add_argument(
        "--config",
        type=str,
        default="config/sac_v442_2_balanced_config.json",
