...
*このドキュメントはv445プロジェクトの技術仕様書として機能し、すべての実装・検証の基準となります。*</content>
<parameter name="filePath">c:\Users\Admin\dev\zaif-trade-bot\SAC_v445_ADVANCED_REGIME_ADAPTATION.md