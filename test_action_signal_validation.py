...
def test_pattern_validation():
    ...
    analysis_with_correlations = guide.analyze_pattern_effectiveness(mock_trading_results)
    print("\nAnalysis with Trading Correlations:")
    if 'correlation_analysis' in analysis_with_correlations:
        for pattern, correlations in analysis_with_correlations['correlation_analysis'].items():
            print(f"  {pattern}:")
