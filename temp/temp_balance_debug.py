...
print(
    "calc.calculate_balance_penalty(ACTION_BUY)",
    calc.calculate_balance_penalty(ACTION_BUY, action_bonus=0.0),
)
...
print(
    "calc.calculate_balance_penalty(ACTION_SELL)",
    calc.calculate_balance_penalty(ACTION_SELL, action_bonus=0.0),
)
