...
if actions:
    ...
    print(
        f"アクション詳細: BUY={buy_count} ({buy_count/total_actions*100:.1f}%), HOLD={hold_count} ({hold_count/total_actions*100:.1f}%), SELL={sell_count} ({sell_count/total_actions*100:.1f}%)"
    )
else:
    print("アクション履歴なし")
