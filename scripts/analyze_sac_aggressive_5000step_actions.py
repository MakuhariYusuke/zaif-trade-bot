...
def main():
    ...
    print(
        f"  Hold Signals (-0.02 to 0.02): {analysis['action_distribution']['hold_signals']}"
    )
    ...
    if (
        analysis["action_distribution"]["hold_signals"]
        > analysis["total_actions"] * 0.98
    ):
