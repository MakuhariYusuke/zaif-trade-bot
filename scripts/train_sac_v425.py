...
def run_v425_training(total_timesteps: int = 15000, config_file: str = "configs/sac_v425_strong_penalty.json") -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="configs/sac_v425_strong_penalty.json", help="Config file path")
