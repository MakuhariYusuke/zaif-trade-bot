"""
SAC v397d_balanced_fix Backtest Script
Next Steps実装版の効果検証
"""
...
def run_backtest(
    ...
    print("=" * 80)
    print("SAC v397d_balanced_fix Backtest")
    print("=" * 80)
    ...
    config = {
        ...
        "continuous_to_discrete_threshold": 0.20,
        "reward_settings": {
    ...
    # 最終残高の取得
    initial_balance = getattr(env, "initial_portfolio_value", 200000.0)
...
if __name__ == "__main__":
    model_path = project_root / "checkpoints" / "sac_session" / "sac_v397d_balanced_fix_final.zip"
    ...
    # JSON保存
    output_path = project_root / "docs" / "evaluation" / "backtest_sac_v397d_balanced_fix_results.json"
    ...
    # v396, v397a, v397b, v397cとの比較
    print("\n" + "=" * 80)
    print("COMPARISON: v396 vs v397a vs v397b vs v397c vs v397d")
    print("=" * 80)
    ...
    comparison_data = {
        ...
        "v397c": {"HOLD": 76.1, "trades": 1194, "return": -45.20, "pos_reward": 1.1},
        "v397d": {
