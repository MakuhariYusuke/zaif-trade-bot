#!/usr/bin/env python3
"""
Train SAC v504 Hold Focus 1 with strong hold preference.
"""
...
def main():
    """Train SAC v504 model with strong hold preference."""
    config_path = "config/sac_v504_hold_focus_1_config.json"
    ...
    print("Training SAC v504 Hold Focus 1:")
    ...
    # Use unified trainer
    sys.argv = ['train_sac_v504_hold_focus_1.py', '--config', config_path]
    train_main()
