...
def run_backtest(model_path, data_path, output_path=None):
    ...
    try:
        ...
        class SimpleTradingEnv(gym.Env):
            ...
            def _get_obs(self):
                return self.data.iloc[self.current_step][features].values.astype(np.float32)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data', default='btc_jpy_real_dataset.csv', help='Path to data file')
