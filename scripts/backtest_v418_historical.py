#!/usr/bin/env python3
"""
Historical Backtest for SAC v418 Model - Fixed Version
"""
...
def run_historical_backtest(
    ...
    for step in range(max_steps):
        ...
        # Convert continuous action to discrete using same thresholds as paper trading
...
def main():
    # Configuration for SAC v418 - same as paper trading
    ...
    output_path = "results/backtest_v418_historical_fixed.json"
    max_steps = 5000
    ...
    try:
        ...
        # Print results
        print("=" * 60)
        print("HISTORICAL BACKTEST RESULTS - SAC v418 (Fixed)")
        print("=" * 60)
