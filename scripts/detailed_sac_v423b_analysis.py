...
class DetailedSACv423bAnalyzer:
    ...
    def estimate_position_holding_intervals(self) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            'avg_holding_interval_minutes': avg_hold_interval * 5,  # Assuming 5-min candles
    ...
    def analyze_action_patterns(self) -> Dict[str, Any]:
        ...
        patterns = {
            ...
            'trading_style': self._classify_trading_style(buy_ratio, sell_ratio, hold_ratio)
        }
    ...
    def analyze_performance_metrics(self) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            'memory_usage': self.report_data.get('system_info', {}).get('memory_available', 0),
    ...
    def _classify_trading_style(self, buy_ratio: float, sell_ratio: float, hold_ratio: float) -> str:
    ...
    def generate_comprehensive_report(self) -> None:
        ...
        if action_analysis:
            ...
            print(f"   Dominant Action: {action_analysis['dominant_action']} ({action_analysis['dominant_ratio']:.3f})")
        ...
        if holding_analysis:
            ...
            print(f"   Average Holding Interval: {holding_analysis['avg_holding_interval_steps']:.1f} steps")
            print(f"   Average Holding Time: {holding_analysis['avg_holding_interval_minutes']:.1f} minutes")
            print(f"   Estimated Total Trades: {holding_analysis['estimated_total_trades']:,}")
            print(f"   Trading Frequency: {holding_analysis['trading_frequency_per_1000_steps']:.1f} trades/1000 steps")
            print(f"   Position Stability: {holding_analysis['position_stability']:.3f}")
            print(f"   Trading Aggressiveness: {holding_analysis['trading_aggressiveness']:.3f}")
            print()
        ...
        if pattern_analysis:
            ...
            print(f"   Balance Assessment: {pattern_analysis['balance_interpretation']}")
            print(f"   Action Entropy: {pattern_analysis['action_entropy']:.3f}")
            print(f"   Entropy Assessment: {pattern_analysis['entropy_interpretation']}")
            print(f"   Expected Consecutive Holds: {pattern_analysis['expected_consecutive_holds']:.1f}")
        ...
        if perf_analysis:
            ...
            print(f"   Memory Usage: {perf_analysis['memory_usage'] / (1024**3):.1f} GB available")
            print(f"   Action Diversity Score: {perf_analysis['action_diversity_score']:.3f}")
            print()
