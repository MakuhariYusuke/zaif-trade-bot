...
def analyze_sac_actions(model_path: str, config_path: str, num_samples: int = 5000):
    ...
    for _ in range(num_samples):
        ...
        action_discrete = continuous_to_discrete_action(action_continuous[0], threshold=0.1)
    ...
    print(f"Continuous→Discrete Threshold: 0.1")
    print()
    ...
    bars = plt.bar(action_labels, action_values, color=['orange', 'green', 'red'], alpha=0.7)
    plt.ylabel('Count')
