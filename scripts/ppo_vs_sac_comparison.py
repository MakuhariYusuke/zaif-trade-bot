...
def compare_sac_vs_ppo():
    ...
    try:
        ...
        print("SAC Results:")
        print(f"  BUY:  {sac_results['sac_action_distribution']['BUY']['count']} ({sac_results['sac_action_distribution']['BUY']['percentage']}%)")
        print(f"  SELL: {sac_results['sac_action_distribution']['SELL']['count']} ({sac_results['sac_action_distribution']['SELL']['percentage']}%)")
        print(f"  HOLD: {sac_results['sac_action_distribution']['HOLD']['count']} ({sac_results['sac_action_distribution']['HOLD']['percentage']}%)")
    except:
