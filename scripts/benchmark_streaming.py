...
class StreamingBenchmark:
    ...
    async def benchmark_data_ingestion(self, num_messages: int = 10000) -> BenchmarkResult:
    ...
    async def benchmark_signal_processing(self, num_signals: int = 5000) -> BenchmarkResult:
        ...
        for i in range(num_signals):
            ...
            if i >= 20:
                ...
                signal = 1 if price > ma20 * 1.001 else (-1 if price < ma20 * 0.999 else 0)
            else:
                signal = 0
    ...
    async def benchmark_order_execution(self, num_orders: int = 1000) -> BenchmarkResult:
