#!/usr/bin/env python3
"""
Analyze action distribution from 5000-step trained SAC model
5000ステップ学習済みSACモデルのアクション分布分析
"""
...
def analyze_action_distribution(model_path, n_episodes=10):
    """Analyze action distribution from trained model"""
    logger.info(f"Analyzing action distribution from {model_path}")
...
def main():
    ...
    # Analyze action distribution
    analysis, actions, rewards, obs = analyze_action_distribution(model_path)

    # Save analysis results
    analysis_path = "analysis/sac_5000step_action_analysis.json"
