"""179# RegimePolicyConfig + CycleStrategy Protocol — regime 別制御量の分離.
...
188# 分割: DefaultCycleStrategy → cycle_strategy.py に移動

MAX LINES: 250 (config + protocol のみ)
"""
...
# ======================================================================
# 188# 後方互換 re-export — DefaultCycleStrategy は cycle_strategy.py に分離
# ======================================================================

from scripts.v460.lib.cycle_strategy import DefaultCycleStrategy  # noqa: E402, F401
