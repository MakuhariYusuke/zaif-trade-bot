...
_HOT_RELOADABLE_FIELDS: frozenset[str] = frozenset({
    ...
    "as_trailing_gate_window_size",
    "as_trailing_gate_spread_bucket_edges",
    "as_trailing_gate_soft_threshold",
    "as_trailing_gate_hard_veto_threshold",
    "as_trailing_gate_offset_boost_factor",
    "as_trailing_gate_min_samples",
    # 193# EV soft offset
    ...
    "skip_gate_sell_trending_down_offset",
    "dust_sweep_enabled",
    ...
    "regime_exit_strategy_enabled",
    "regime_exit_max_trending_down_buy_fills",
    "regime_exit_tracking_window_sec",
    "regime_exit_escalated_max_factor",
    "regime_exit_nfq_trigger_imbalance",
    ...
    "cross_venue_buy_protect_enabled",
    "cross_venue_buy_veto_spread_bps",
    "cross_venue_buy_boost_spread_bps",
    "cross_venue_buy_offset_boost_factor",
