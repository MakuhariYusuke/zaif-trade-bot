...
from ztb.features.optimizer_features import get_optimizer_tracker, update_optimizer_features

# FeatureRegistryを初期化
FeatureRegistry.initialize()

# Optimizer特徴量が登録されているか確認
optimizer_features = [f for f in FeatureRegistry.list() if f.startswith('optimizer_')]
