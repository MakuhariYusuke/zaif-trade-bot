...
def test_reward_scenarios():
    ...
    print("=" * 80)
    print(f"Current Settings:  scale={reward_settings_current['reward_scale']}, clip=[{reward_settings_current['reward_clip_min']}, {reward_settings_current['reward_clip_max']}]")
    print(f"Improved Settings: scale={reward_settings_improved['reward_scale']}, clip=[{reward_settings_improved['reward_clip_min']}, {reward_settings_improved['reward_clip_max']}]")
    print()
