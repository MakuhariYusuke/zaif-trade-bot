...
def run_multi_stage_phase(phase_name, timesteps, focus, base_config):
    ...
    if focus == "high_entropy_exploration":
        ...
        phase_config['reward_function']['buy_bonus'] = 0.1  # Lower rewards to encourage exploration
        ...
        phase_config['reward_function']['buy_bonus'] = 0.4  # Higher rewards for good actions
...
def run_multi_stage_training():
    ...
    # Training phases
    phases = [
        {"name": "exploration", "timesteps": 40000, "focus": "high_entropy_exploration"},
        {"name": "exploitation", "timesteps": 40000, "focus": "optimal_policy_learning"},
    ...
    for i, result in enumerate(multi_stage_results):
        ...
        entropy = "High" if "exploration" in focus else "Low" if "refinement" in focus else "Medium"
        print(".4f")
